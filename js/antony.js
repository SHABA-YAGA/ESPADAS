...
//     var month = Number(document.getElementById("Location").value);
//     var year = Number(document.getElementById("email").value);
//     var century = Number(document.getElementById("choose").value);
